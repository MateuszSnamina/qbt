...
ExpressionHandlerOptional transform_sort_product_of_boson_primitive_operators_2(const ExpressionHandler& expression) {
    ...
    // ***************************************************************
    // ****** the transformation does apply to product              **
    // ****** of zero or one subexpressions                         **
    // ***************************************************************
    ...
    // ***************************************************************
    // ****** the transformation applies only to product            **
    // ****** of BosonCreationAnnihilationBase operators            **
    // ***************************************************************
    ...
    // ***************************************************************
    // ****** count number of creation operators and                **
    // ****** count number of annihilation operators                **
    // ***************************************************************
    ...
    // ***************************************************************
    // ****** the transformation applies only to product            **
    // ****** of operators in not the desired operators order       **
    // ***************************************************************
    ...
    const auto is_transform_an_cr_to_cr_an = [index_of_first_not_matching_subexpression, &desired_state_calculator]() -> bool {
        const auto sought_cr_an = desired_state_calculator(index_of_first_not_matching_subexpression);
    ...
    if (is_transform_an_cr_to_cr_an()) {  //TODO logic
