...
ExpressionHandlerOptional modify_rebuild_prod_sum_into_sum_prod(const ExpressionHandler& expression) {
    // ***************************************************************
    ...
    // ***************************************************************
    // *** return the expression in the rebuild_prod_sum_into_sum_proded form               **
    // ***************************************************************
