#ifndef BOSON_ALGEBRA_TRANSFORM_DETECT_BRIDGE_NUMEROUS_EXPRESSION_HPP
#define BOSON_ALGEBRA_TRANSFORM_DETECT_BRIDGE_NUMEROUS_EXPRESSION_HPP
...
ExpressionHandlerOptional transform_detect_bridge_numerous_expression(const ExpressionHandler& expression) {
