...
TEST(ModifySortProductOfBosonPrimitiveOperators0OldApiOldApi, OnBosonPrimitiveOperator) {
    const auto expression = 'd'_cr;
    ASSERT_EQ(expression.str(), "♯d");
    //std::cout << expression.str() << std::endl;
    const auto transformed_expression_optional = modify_sort_product_of_boson_primitive_operators_0(expression);
    ASSERT_FALSE(transformed_expression_optional);
}

TEST(ModifySortProductOfBosonPrimitiveOperators0OldApi, OnEmptySum) {
...
TEST(ModifySortProductOfBosonPrimitiveOperators0OldApi, OnEmptyProduct) {
...
TEST(ModifySortProductOfBosonPrimitiveOperators0OldApi, OnProductOfBosonPrimitiveOperators1) {
...
TEST(ModifySortProductOfBosonPrimitiveOperators0OldApi, OnProductOfBosonPrimitiveOperators2) {
...
TEST(ModifySortProductOfBosonPrimitiveOperators0OldApi, OnProductOfBosonPrimitiveOperators3) {
...
TEST(ModifySortProductOfBosonPrimitiveOperators0OldApi, OnHeterogeneousProductOfBosonPrimitiveOperators3) {
