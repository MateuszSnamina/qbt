...
TEST(ModifySimplifyLinearCombinationOldApi, OnBosonPrimitiveOperator) {
...
TEST(ModifySimplifyLinearCombinationOldApi, OnEmptyProduct) {
...
TEST(ModifySimplifyLinearCombinationOldApi, OnProductOfBosonPrimitiveOperators) {
...
TEST(ModifySimplifyLinearCombinationOldApi, OnFactorExpression) {
...
TEST(ModifySimplifyLinearCombinationOldApi, MinimalWorkingExample1) {
...
TEST(ModifySimplifyLinearCombinationOldApi, MinimalWorkingExample2) {
...
TEST(ModifySimplifyLinearCombinationOldApi, MinimalWorkingExample3) {
...
TEST(ModifySimplifyLinearCombinationOldApi, MinimalNotWorkingExample1) {
